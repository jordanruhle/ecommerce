            ...
            <form className='bg-white p-10' encType="multipart/form-data" onSubmit={submitFunction}>
                ...
                <div className="md:flex">
                    <div className='mb-6 mr-8 w-full'>
                        ...
                        <input onChange={ changeHandler } type="text" pattern="[0-9]+([.][0-9]{2})?" placeholder='0.00' name="price" value={productInfo.price} className='w-full p-3 border' />
                    </div>
                ...
                <div className="md:flex">
                    <div className='mb-6 mr-8 w-full'>
                        ...
                        <input onChange={ changeHandler } type="color" name="color" value={productInfo.color} className=' w-full p-3 border' />
                    </div>
